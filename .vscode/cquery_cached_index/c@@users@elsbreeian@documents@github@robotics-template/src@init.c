...
void initialize() {
  ...
  bool is_not_reversed = false;
  encoderLM = encoderInit(ENCODER_LEFT_TOP, ENCODER_LEFT_BOTTOM, is_reversed);
  encoderRM =
      encoderInit(ENCODER_RIGHT_TOP, ENCODER_RIGHT_BOTTOM, is_not_reversed);
}
